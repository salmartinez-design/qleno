...
const RevenueForecastPage = lazy(() => import("@/pages/reports/revenue-forecast"));
...
// [ares-parity 2026-08-19] The Ares Commissions portal. One route — the seven
// admin tabs are internal state, and a non-office user is routed to their own
// statement inside the component.
const CommissionsPage     = lazy(() => import("@/pages/reports/recurring/commissions"));
...
function PageLoader() {
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "100vh", background: "#F7F6F4" }}>
      <div style={{ width: 32, height: 32, border: "3px solid #E5E2DC", borderTopColor: "#2F3646", borderRadius: "50%", animation: "spin 0.8s linear infinite" }} />
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      ...
      <Switch>
        ...
        <Route path="/reports/revenue-forecast" component={RevenueForecastPage} />
        ...
        <Route path="/reports/commissions" component={CommissionsPage} />
