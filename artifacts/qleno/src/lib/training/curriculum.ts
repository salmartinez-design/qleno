...
const BASE_QUIZ: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { en: "Phes invokes the Fix-It guarantee — the office sends the client a Shortfall Report form, asks for photos to verify, and schedules the return visit as soon as the client is available", es: "Phes invoca la garantía Fix-It — la oficina envía al cliente un formulario de Reporte de Deficiencia, pide fotos para verificar, y programa la visita de regreso tan pronto como el cliente esté disponible" },
