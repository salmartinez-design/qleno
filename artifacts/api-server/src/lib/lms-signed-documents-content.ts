...
const CODE_OF_CONDUCT_EN: SignedDocumentLocaleContent = {
  ...
  contentHtml: [
    ...
    "Effective Date: January 1, 2026",
    "",
    "By signing this acknowledgment, I confirm that I have read and understand the Phes Code of Conduct contained in the 2026 Phes Employee Handbook and the Code of Conduct training module. I commit to the following terms as a condition of my employment with Phes Cleaning Servicess:",
    "",
...
const CODE_OF_CONDUCT_ES: SignedDocumentLocaleContent = {
  ...
  contentHtml: [
    ...
    "Fecha Efectiva: 1 de enero de 2026",
    "",
    "Al firmar este reconocimiento, confirmo que he leído y entiendo el Código de Conducta de Phes contenido en el Manual del Empleado de Phes 2026 y en el módulo de capacitación del Código de Conducta. Me comprometo a los siguientes términos como condición de mi empleo con Phes Cleaning Servicess:",
    "",
...
const NON_SOLICITATION_EN: SignedDocumentLocaleContent = {
  ...
  contentHtml: [
    ...
    "Effective Date: January 1, 2026",
    "",
    "This Non-Solicitation Agreement is entered into between Phes Cleaning Servicess and me as a condition of my employment. The Agreement is governed by the Illinois Freedom to Work Act, 820 ILCS 90, and is intentionally narrowed to remain reasonable in scope, duration, and protected interest.",
    "",
    ...
    "Phes Client means any household, person, or business that has received cleaning services from Phes Cleaning Servicess in the twenty-four months prior to my last day with Phes.",
    "",
...
const NON_SOLICITATION_ES: SignedDocumentLocaleContent = {
  ...
  contentHtml: [
    ...
    "Fecha Efectiva: 1 de enero de 2026",
    "",
    "Este Acuerdo de No Solicitación se celebra entre Phes Cleaning Servicess y yo como condición de mi empleo. El Acuerdo se rige por la Ley de Libertad para Trabajar de Illinois, 820 ILCS 90, y se restringe intencionalmente para permanecer razonable en alcance, duración e interés protegido.",
    "",
    ...
    "Cliente de Phes significa cualquier hogar, persona o negocio que haya recibido servicios de limpieza de Phes Cleaning Servicess en los veinticuatro meses anteriores a mi último día con Phes.",
    "",
...
const SOCIAL_MEDIA_EN: SignedDocumentLocaleContent = {
  ...
  contentHtml: [
    ...
    "Effective Date: January 1, 2026",
    "",
    "By signing this acknowledgment, I confirm that I have read and understand the Phes Social Media Policy contained in the 2026 Phes Employee Handbook and the Social Media training module. I commit to the following terms as a condition of my employment with Phes Cleaning Servicess:",
    "",
...
const SOCIAL_MEDIA_ES: SignedDocumentLocaleContent = {
  ...
  contentHtml: [
    ...
    "Fecha Efectiva: 1 de enero de 2026",
    "",
    "Al firmar este reconocimiento, confirmo que he leído y entiendo la Política de Redes Sociales de Phes contenida en el Manual del Empleado de Phes 2026 y en el módulo de capacitación de Redes Sociales. Me comprometo a los siguientes términos como condición de mi empleo con Phes Cleaning Servicess:",
    "",
...
const SUPPLY_KIT_EN: SignedDocumentLocaleContent = {
  ...
  contentHtml: [
    ...
    "Effective Date: January 1, 2026",
    "",
    "By signing this acknowledgment, I confirm that I have read and understand the Phes Supply Kit Responsibility Policy contained in the 2026 Phes Employee Handbook and the Supply Kit training module. I commit to the following terms as a condition of my employment with Phes Cleaning Servicess:",
    "",
    "1. PHES PROPERTY.",
    "Every item Phes issues to me as part of my supply kit is the property of Phes Cleaning Servicess and is loaned to me for the duration of my employment. This includes the cleaning caddy, color-coded microfiber cloths, mop and bucket, any assigned vacuum, step stool, Phes-branded refillable chemical bottles and their contents, Phes-branded uniform (shirt, apron, name badge), shoe covers, any assigned Phes phone or tablet, and any client keys, key cards, or alarm-code cards I am issued.",
    "",
    "2. REASONABLE CARE.",
...
const HANDBOOK_EN: SignedDocumentLocaleContent = {
  ...
  contentHtml: [
    ...
    "I acknowledge that I have received, read, and understood the Phes Cleaning Services Employee Handbook in its entirety. I understand the policies, procedures, and expectations described in it.",
    "",
    "## At-Will Employment",
    "I understand and agree that my employment with Phes Cleaning Services is at-will. Either I or Phes may end the employment relationship at any time, with or without cause and with or without notice. No statement in this handbook, and no statement made by any Phes employee, creates a contract for continued employment or alters this at-will relationship.",
    "",
...
const HANDBOOK_ES: SignedDocumentLocaleContent = {
  ...
  contentHtml: [
    ...
    "Reconozco que he recibido, leído y comprendido en su totalidad el Manual del Empleado de Phes Cleaning Services. Comprendo las políticas, procedimientos y expectativas descritas en él.",
    "",
    "## Empleo a Voluntad",
    "Entiendo y acepto que mi empleo con Phes Cleaning Services es a voluntad. Yo o Phes podemos terminar la relación laboral en cualquier momento, con o sin causa y con o sin aviso. Ninguna declaración en este manual, ni hecha por ningún empleado de Phes, crea un contrato de empleo continuo ni altera esta relación a voluntad.",
    "",
