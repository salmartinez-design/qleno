...
const CODE_OF_CONDUCT_EN: SignedDocumentLocaleContent = {
  ...
  contentHtml: [
    ...
    "What I see and hear inside a client's home stays inside that home. I will not photograph or video a client's property except to document a Phes-authorized issue uploaded directly to Qleno. I will not share details about a client's home, possessions, or family with anyone outside Phes, including on social media. I will not access closed rooms, locked closets, or drawers not listed on the Worksheet, and I will not look through mail, documents, or personal items.",
    "",
