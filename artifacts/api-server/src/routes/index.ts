...
import dispatchEventsRouter from "./dispatch-events.js";
import oneOnOnesRouter from "./one-on-ones.js";
import portalRouter from "./portal.js";
import portalAuthRouter from "./portal-auth.js";
import portalAccountRouter from "./portal-account.js";
...
import mileageRatesRouter from "./mileage-rates.js";
import mileageRequestsRouter from "./mileage-requests.js";
import pricingRouter from "./pricing.js";
import propertyLookupRouter from "./property-lookup.js";
...
router.use("/dispatch-events", dispatchEventsRouter);
router.use("/one-on-ones", oneOnOnesRouter);
...
router.use("/mileage-rates", mileageRatesRouter);
router.use("/mileage-requests", mileageRequestsRouter);
router.use("/pricing", pricingRouter);
router.use("/property-lookup", propertyLookupRouter);
