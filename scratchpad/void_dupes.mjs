...
const TARGETS = [1010, 1023, 1083, 1089, 1100, 1149, 1158];
const SNAP = "invoice_void_snapshot_20260722";
...
const KEEPERS = [1012, 985, 1093]; // Azzarello batch, Halper batch, Cucci #7039
...
if (MODE === "commit") {
  ...
  const rb = `-- Rollback for the 2026-07-22 duplicate-invoice void.
...
COMMIT;
`;
  fs.writeFileSync("/Users/salvadormartinez/qleno/scratchpad/rollback_void_dupes.sql", rb);
  console.log("  rollback script → scratchpad/rollback_void_dupes.sql");
}
